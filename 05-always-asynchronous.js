...
let async_Promise = new Promise(function(fulfill, reject) {
  fulfill('PROMISE VALUE')//immediately fulfill promise
});
async_Promise.then(console.log, null) //pass console.log as the success handler
